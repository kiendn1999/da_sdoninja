      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Container(
          ...
          child: Row(
            ...
            children: [
              _buttonBottomBar(onPressed: () {}, title: "help_me".tr, color: AppColors.orange),
              _buttonBottomBar(onPressed: () {}, title: "chat".tr, color: AppColors.blue2),
              _buttonBottomBar(onPressed: () {}, title: "share".tr, color: context.isDarkMode ? AppColors.primaryDarkModeColor : AppColors.primaryLightModeColor),
            ],
          ),
        ),
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          _nontifiClosed(),
          _shopName(),
          _listTileWithIconLeading(pathImage: AppImages.icStarSelected, title: "4.5 (25)"),
          _distanceAddress(),
          _listTileWithCheckBoxLeading(value: true, context: context, title: "on_site_repair".tr, onChanged: (value) {}),
          _listTileWithCheckBoxLeading(value: false, context: context, title: "delivery".tr, onChanged: (value) {}),
  ...
  Container _distanceAddress() {
    return Container(
      ...
      child: Row(
        ...
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          _listTileWithIconLeading(marginTop: 0, pathImage: AppImages.icDistance, title: "1 km"),
          SizedBox(
            width: 200.w,
            child: Text(
